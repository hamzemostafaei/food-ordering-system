package com.food.ordering.system.order.data.access.outbox.payment.adapter;

import com.food.ordering.system.order.data.access.outbox.payment.exception.PaymentOutboxNotFoundException;
import com.food.ordering.system.order.data.access.outbox.payment.mapper.PaymentOutboxDataAccessMapper;
import com.food.ordering.system.order.data.access.outbox.payment.repository.IPaymentOutboxJpaRepository;
...
public class PaymentOutboxRepositoryImpl implements IPaymentOutboxRepository {

    private final IPaymentOutboxJpaRepository paymentOutboxJpaRepository;
